...
namespace University_Managment_System.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            var uniContext = _context.Courses.Include(c => c.Department).Include(c => c.Semester);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Credits,DepartmentId,SemesterId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Credits,DepartmentId,SemesterId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();

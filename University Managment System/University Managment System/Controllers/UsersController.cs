...
namespace University_Managment_System.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var uniContext = _context.Users.Include(u => u.Role);
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,PasswordHash,RoleId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,PasswordHash,RoleId")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
